...
function AddNewCoursePage(){
    ...
    const {courseLandingFormData, courseCurriculumFormData, 
        ...
        currentEditedCourseId, setCurrentEditedCourseId,}  = useContext(InstructorContext);
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="flex justify-between">
                <h1 className="text-3xl font-extrabold mb-5 text-teal-600">Create New Course</h1>
                <Button 
                disabled={!validateFormData()} 
                className="text-sm tracking-wider font-bold px-8 bg-teal-600 text-white"
